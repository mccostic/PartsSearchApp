...
class MockPartsDataService : PartsDataService {
  ...
  companion object {
    ...
    val parts = listOf(
      ...
      Part(1, "Front Brake Pad Set", "BP-TY-001", 11, "Premium ceramic front brake pads", listOf("Ceramic compound", "Low dust", "Anti-squeal shim included"), toyotaEngineIds),
      Part(2, "Rear Brake Pad Set", "BP-TY-002", 11, "OEM quality rear brake pads", listOf("Semi-metallic", "Built-in wear indicator"), toyotaEngineIds),
      Part(3, "Front Brake Pad Set", "BP-HN-001", 11, "High performance front brake pads", listOf("Carbon-ceramic", "Track-rated"), hondaEngineIds),
      Part(4, "Front Brake Pad Set", "BP-UN-001", 11, "Universal fit front brake pads", listOf("Economy range", "Standard compound"), universalEngineIds),

      // Brake Rotors (categoryId = 12)
      Part(5, "Front Brake Rotor", "BR-TY-001", 12, "Ventilated front brake disc", listOf("280mm diameter", "Ventilated"), toyotaEngineIds),
      Part(6, "Rear Brake Rotor", "BR-TY-002", 12, "Solid rear brake disc", listOf("260mm diameter", "Solid"), toyotaEngineIds),

      // Oil Filters (categoryId = 21)
      Part(7, "Oil Filter", "OF-TY-001", 21, "Spin-on oil filter for Toyota engines", listOf("Micron rating: 20", "Anti-drain back valve"), toyotaEngineIds),
      Part(8, "Oil Filter", "OF-HN-001", 21, "Oil filter for Honda engines", listOf("Micron rating: 15", "Silicone anti-drain valve"), hondaEngineIds),
      Part(9, "Oil Filter", "OF-UN-001", 21, "Universal spin-on oil filter", listOf("Multi-vehicle fit", "Standard filtration"), universalEngineIds),

      // Air Filters (categoryId = 22)
      Part(10, "Engine Air Filter", "AF-TY-001", 22, "Panel-type engine air filter", listOf("High-flow", "Washable option"), toyotaEngineIds),
      Part(11, "Engine Air Filter", "AF-HN-001", 22, "OEM replacement air filter", listOf("Standard flow", "Paper element"), hondaEngineIds),

      // Spark Plugs (categoryId = 23)
      Part(12, "Spark Plug (Set of 4)", "SP-TY-001", 23, "Iridium spark plugs for 4-cylinder Toyota", listOf("Iridium tip", "Pre-gapped", "60,000km life"), toyotaEngineIds),
      Part(13, "Spark Plug (Set of 4)", "SP-UN-001", 23, "Standard copper spark plugs", listOf("Copper core", "20,000km life"), universalEngineIds),

      // Radiator (categoryId = 31)
      Part(14, "Radiator Assembly", "RD-TY-001", 31, "Complete radiator assembly", listOf("Aluminum core", "Plastic tanks", "Includes cap"), toyotaEngineIds),

      // Water Pump (categoryId = 32)
      Part(15, "Water Pump", "WP-TY-001", 32, "Engine water pump with gasket", listOf("Cast iron body", "Gasket included"), toyotaEngineIds),

      // Thermostat (categoryId = 33)
      Part(16, "Thermostat", "TH-UN-001", 33, "Standard thermostat with housing", listOf("82 degrees Celsius", "Housing included"), universalEngineIds),

      // Battery (categoryId = 51)
      Part(17, "Car Battery 12V 60Ah", "BT-UN-001", 51, "Maintenance-free car battery", listOf("12V", "60Ah", "540 CCA", "24-month warranty"), universalEngineIds),
      Part(18, "Car Battery 12V 75Ah", "BT-UN-002", 51, "Heavy-duty car battery", listOf("12V", "75Ah", "680 CCA", "36-month warranty"), universalEngineIds),

      // Alternator (categoryId = 52)
      Part(19, "Alternator", "AL-TY-001", 52, "Remanufactured alternator", listOf("100A output", "Internal regulator"), toyotaEngineIds),

      // Shock Absorber (categoryId = 61)
      Part(20, "Front Shock Absorber (Pair)", "SA-TY-001", 61, "Gas-charged front shock absorbers", listOf("Twin-tube", "Gas-charged", "Pair"), toyotaEngineIds),
      Part(21, "Rear Shock Absorber (Pair)", "SA-TY-002", 61, "Gas-charged rear shock absorbers", listOf("Twin-tube", "Gas-charged", "Pair"), toyotaEngineIds),

      // Wiper Blades (categoryId = 92)
      Part(22, "Wiper Blade Set", "WB-UN-001", 92, "All-season wiper blade set", listOf("Beam style", "Driver + Passenger", "Universal fit"), universalEngineIds),
    )
