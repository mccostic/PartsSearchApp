  ...
  private fun getMockOrders(): List<Order> {
    return listOf(
      ...
      Order(
        id = 1002,
        items = listOf(
          CartItem(2, VendorListing(23, 10, params.vendorId, "Self", "TOYOTA GENUINE", "90915-YZZD4", 35.0, "GHS", true, 100), "Oil Filter", 3)
        ),
      ...
      Order(
        id = 1003,
        items = listOf(
          CartItem(3, VendorListing(64, 30, params.vendorId, "Self", "VARTA", "D24", 450.0, "GHS", true, 10), "Car Battery 12V 60Ah", 1)
        ),
      ...
      Order(
        id = 1004,
        items = listOf(
          CartItem(4, VendorListing(39, 16, params.vendorId, "Self", "DENSO", "SK20R11", 95.0, "GHS", true, 40), "Iridium Spark Plug Set", 2)
        ),
        status = OrderStatus.DELIVERED,
      ...
      Order(
        id = 1005,
        items = listOf(
          CartItem(5, VendorListing(52, 21, params.vendorId, "Self", "DENSO", "DRM50034", 650.0, "GHS", true, 3), "Radiator Assembly", 1)
        ),
