package com.app.partssearchapp.screens.home.data
 ...
 */
class NetworkRepositoryService(private val apiClient: ApiClient,) : RepositoryService {
    ...
    override suspend fun getRepository(id: Int): Repository? = try {
